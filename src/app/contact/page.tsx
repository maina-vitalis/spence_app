...
export default function ContactPage() {
  return (
    <main className="space-y-16">
      {/* Top Section */}
      <section className="mx-auto px-4 mt-6 space-y-10">
        ...
        <div className="flex justify-center gap-5 flex-wrap">
          {/* Location Card */}
          <div className="shadow-sm p-5 rounded-3xl space-y-5 sm:w-56 min-w-56 w-full bg-orange-100/50 dark:bg-orange-900/50">
          ...
          {/* Call Card */}
          <div className="shadow-sm p-5 rounded-3xl space-y-5 sm:w-56 min-w-56 w-full bg-green-100/50 dark:bg-green-900/50">
            <div className="flex gap-3 items-center">
          ...
          {/* Mail Card */}
          <div className="shadow-sm p-5 rounded-3xl space-y-5 sm:w-56 min-w-56 w-full bg-blue-100/50 dark:bg-blue-900/50">
            <div className="flex gap-3 items-center">
          ...
          {/* Working Hours */}
          <div className="shadow-sm p-5 rounded-3xl space-y-5 sm:w-56 min-w-56 w-full bg-indigo-100/50 dark:bg-indigo-500/50">
            <div className="flex gap-3 items-center">
