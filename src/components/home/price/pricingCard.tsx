...
export default function PricingCard({
  ...
  return (
    <Card className="bg-gradient-to-br from-primary/10 via-transparent to-primary/10">
        ...
        <div className="mt-8">
          ...
          <div className="flex gap-3 flex-wrap">
            {technologies.map((tech, index) => (
              <div
                key={index}
                className="flex items-center gap-1.5 border border-primary px-3 py-1.5 rounded-full transition-all duration-300 hover:scale-105 hover:shadow-md"
              >
                <div
                  className={cn(
